...
<link href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/bootstrap/dist/css/bootstrap.min.css') }}"
    rel="stylesheet">
...
<link
    href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}"
    rel="stylesheet">
<link href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/jqvmap/dist/jqvmap.min.css') }}" rel="stylesheet">
<link href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/bootstrap-daterangepicker/daterangepicker.css') }}"
    rel="stylesheet">
...
<link href="{{ asset('theme1/assets/themes/legacy/css/custom.css?v=1781380426') }}" rel="stylesheet">
...
<link href="{{ asset('theme1/assets/themes/legacy/css/timeticker.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/news-ticker-acme/assets/css/style.min.css') }}"
    rel="stylesheet">
<link href="{{ asset('theme1/assets/themes/legacy/dashboard/vendors/select2/dist/css/select2.min.css') }}"
    rel="stylesheet">
<link href="{{ asset('theme1/assets/themes/legacy/js/datetimepicker/jquery.datetimepicker.css') }}" rel="stylesheet">
<link href="{{ asset('theme1/assets/css/nav.css') }}" rel="stylesheet">
...
<script>
    var baseurl = "{{ url('/') }}/";
    window.appRoutes = {
        getCitiesByAjax: "{{ route('area.getCitiesByAjax') }}",
        getAreaByAjax: "{{ route('area.getAreaByAjax') }}",
        getSubAreaByAjax: "{{ route('area.getSubAreaByAjax') }}"
    };
</script>
